    ...
    return (
      ...
      >
        <ToolbarGroup firstChild={true} float="left">
          <ToolbarTitle text="EDify" style={{fontFamily: 'Fredoka One', cursor: 'pointer', color: 'white', fontSize: '45px', paddingLeft: '12px', paddingTop: '7px', marginRight: '220px'}} onClick={() => this.props.goHome()}/>
